...
#define keywords
search_word_1 = "sanders"
search_word_2 = "clinton"


#create dummy word list to avoid problems later in the analysis
...
while True:
    #set stop time
    if datetime.datetime.now() > datetime.datetime(2016, 3, 7, 5, 00, 0):
        break
    #set start time
    elif datetime.datetime.now() < datetime.datetime(2016, 3, 7, 2, 00, 0):
        pass
    #try taking data
    else:
